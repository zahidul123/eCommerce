...
class CustomColors {
  ...
  static const Color TextBlack = Color(0xff2C3335);
  static const Color White= Color(0xffFFFFFF);
  static const Color silver_White= Color(0xffC0C0C0);
  static const Color red= Color(0xffFF0000);
  static const Color green= Color(0xff008000);
  static const Color gunmetal_black= Color(0xff2C3539);
  static const Color dark_shalet_gray= Color(0xff25383C);
  static const Color dark_shalet_blue= Color(0xff2B3856);
  static const Color jet_gray= Color(0xff616D7E);
  static const Color beetly_green= Color(0xff4C787E);
  static const Color forest_green= Color(0xff347235);
  static const Color alice_blue= Color(0xffF0F8FF);
  static const Color shark_gray= Color(0xff2F363F);
  static const Color optimal_black= Color(0xff47535E);
  static const Color azure_gray= Color(0xffEAF0F1);
}