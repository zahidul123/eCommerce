...
class DashBoardUiView extends State<DashBoard> {
  ...
  Widget build(BuildContext context) {
    base64Image = sharedPreferences.getString("profile_image");
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => TransactionHistoryUi()));
              },
            ),
            ListTile(
